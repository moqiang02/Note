package com.example.rex.note.widget.DatePicket.views;
...
import com.example.rex.note.widget.DatePicket.bizs.languages.DPLManager;
...
import com.example.rex.note.widget.DatePicket.utils.MeasureUtil;
    ...
    public DatePicker(Context context, AttributeSet attrs) {
        ...
        monthView.setOnDateChangeListener(new MonthView.OnDateChangeListener() {
            ...
            public void onMonthChange(int month) {
                RxBus.getDefault().post(new DPicker(month));
