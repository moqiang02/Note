package com.example.rex.note.ui.widget.DatePicket.bizs.calendars;
...
public class DPCNCalendar extends DPCalendar {
    ...
    private static final String[][] FESTIVAL_G = {
            {"元旦"},
            {"世界湿地日", "情人节"},
            {"全国爱耳日", "志愿者服务日", "国际妇女节", "保护母亲河日", "中国植树节", "白色情人节", "消费者权益日", "世界森林日&睡眠日", "世界水日", "世界气象日", "防治结核病日"},
            ...
            {"国际建筑日", "中国抗战纪念日", "世界人口日"},
            {"建军节", "青年节"},
            {"抗战胜利日", "国际扫盲日", "中国教师节", "中国脑健康日", "全国爱牙日", "世界停火日", "世界旅游日"},
            {"国庆节", "世界动物日", "世界教师日", "全国高血压日", "世界邮政日", "世界精神卫生日", "世界标准日", "国际盲人节", "世界粮食日", "国际消除贫困日", "联合国日", "中国男性健康日", "万圣节"},
